...
# 다른 품종에 대한 파생변수 생성
  ...
  양파_train_data_copy = 양파_train_data_copy.drop(columns=columns_to_drop)
  ...
  # 해당 칼럼 삭제
  양파_train_data_copy = 양파_train_data_copy.drop(columns=columns_to_drop, errors='ignore')

  scaler = StandardScaler()
  numeric_columns_양파 = 양파_train_data_copy.select_dtypes(include=[np.number]).columns
  양파_train_data_copy[numeric_columns_양파] = scaler.fit_transform(양파_train_data_copy[numeric_columns_양파])

  return 양파_train_data_copy, scaler
